...
export default function App() {
  ...
  const CITA_INTERES_OPTIONS = [
    ...
    { value: 'Nuvela Diamond', es: 'Nuvela Diamond', en: 'Nuvela Diamond Mattress' },
      ...
      {page === 'producto' && (
        <main className="page-fade">
          ...
          <section className="pb-24 md:pb-32 bg-cream">
            <div className="max-w-5xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-5 mb-6">
              {getCategories().map((c) => {
