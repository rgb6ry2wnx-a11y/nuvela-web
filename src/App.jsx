            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 h-full flex flex-col justify-center">
              <div className="max-w-2xl">
                ...
                <h1 className="text-white font-serif text-5xl md:text-7xl leading-[1.05] mt-8 reveal reveal-delay-1">
                  {t(<>Tecnología diseñada<br />para el descanso perfecto.</>, <>Technology designed<br />for perfect sleep.</>)}
                </h1>
                <p className="text-white/80 text-base md:text-lg mt-6 leading-relaxed max-w-xl reveal reveal-delay-2">
                  {t(
                    'Una experiencia de descanso superior diseñada con estilo italiano — ingeniería de resortes encapsulados, gel memory foam y tejidos transpirables para el descanso que mereces.',
                    'A luxury sleep experience crafted in Italian style — engineered with encapsulated springs, gel memory foam and breathable fabrics for the way you were meant to rest.'
                  )}
                </p>
                <div className="flex flex-wrap gap-4 mt-10 reveal reveal-delay-3">
                  <button onClick={() => go('precios')} className="btn-gold">{t('Comprar Ahora', 'Shop Now')}</button>
